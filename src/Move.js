...
export class Move {
	...
	/**
	 * Computes an unique hash code for the move.
	 *
	 * @returns {number} The hash code representing the move.
	 */
	hashCode(){
		return this.origin().index() | (this.target().index() << 6) | (this.promotionPiece().index() << 12);
	}
